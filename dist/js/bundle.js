...
jquery__WEBPACK_IMPORTED_MODULE_0___default()( document ).ready(function() {
    console.log( "ready!" );
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.second-slick').slick({
        dots: true,
        arrows: false
    });
});
...
// progress-bar init
jquery__WEBPACK_IMPORTED_MODULE_0___default()( document ).ready(function() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.skillbar').each(function(){
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('.skillbar-bar').animate({
            width:jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('data-percent')
        }, 2000);
    })
});
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()( document ).ready(function() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.navbar-toggler').click(function(){
        jquery__WEBPACK_IMPORTED_MODULE_0___default() ('.nav-collapse').slideToggle("show");
    });
});
